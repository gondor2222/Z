...
#include "UnityCG.cginc"
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 36;
			w[0] += 0.6 * R62(r) * d1(pos4.x, pos4.y, pos4.z, r);
			w[1] += 0.6 * R62(r) * d2(pos4.x, pos4.y, pos4.z, r);
			w[2] += 0.6 * R62(r) * d3(pos4.x, pos4.y, pos4.z, r);
			w[3] += 0.6 * R62(r) * d4(pos4.x, pos4.y, pos4.z, r);
			w[4] += 0.6 * R62(r) * d5(pos4.x, pos4.y, pos4.z, r);
		}
