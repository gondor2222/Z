...
#include "UnityCG.cginc"
	...
	float R42(float r) {
		float p = _Z * r / 2;
		return _Z * exp(-p) * (6 - p) * (6 - p) * p * p * p * p * 243 * 243 * 24;
	}
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 16;
			w[0] += 0.14 * R42(r) * d1(pos4.x, pos4.y, pos4.z, r);
			w[1] += 0.14 * R42(r) * d2(pos4.x, pos4.y, pos4.z, r);
			w[2] += 0.14 * R42(r) * d3(pos4.x, pos4.y, pos4.z, r);
			w[3] += 0.14 * R42(r) * d4(pos4.x, pos4.y, pos4.z, r);
			w[4] += 0.14 * R42(r) * d5(pos4.x, pos4.y, pos4.z, r);
		}
