...
#include "UnityCG.cginc"
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 4;
			w1 += 2e-2 *  float3(R21(r) * p1(pos4.x, pos4.y, pos4.z, r),
				R21(r) * p2(pos4.x, pos4.y, pos4.z, r),
				R21(r) * p3(pos4.x, pos4.y, pos4.z, r)
			)
			;
		}
