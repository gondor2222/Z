...
#include "UnityCG.cginc"
	...
	float R41(float r) {
		float p = _Z * r / 2;
		return _Z *  exp(-p) * (20 - 10 * p + p*p) * (20 - 10 * p + p*p) * p * p * 27 * 2;
	}
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 16;
			w1 += 1e0 * float3(R41(r) * p1(pos4.x, pos4.y, pos4.z, r),
				R41(r) * p2(pos4.x, pos4.y, pos4.z, r),
				R41(r) * p3(pos4.x, pos4.y, pos4.z, r)
				)
				;
		}
