...
#include "UnityCG.cginc"
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 16;
			w[0] += 8e6*R43(r) * f1(pos4.x, pos4.y, pos4.z, r);
			w[1] += 8e6*R43(r) * f2(pos4.x, pos4.y, pos4.z, r);
			w[2] += 8e6*R43(r) * f3(pos4.x, pos4.y, pos4.z, r);
			w[3] += 8e6*R43(r) * f4(pos4.x, pos4.y, pos4.z, r);
			w[4] += 8e6*R43(r) * f5(pos4.x, pos4.y, pos4.z, r);
			w[5] += 8e6*R43(r) * f6(pos4.x, pos4.y, pos4.z, r);
			w[6] += 8e6*R43(r) * f7(pos4.x, pos4.y, pos4.z, r);
		}
