...
#include "UnityCG.cginc"
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		for (i = 0; i < 100; i++) {
			...
			r = length(pos4) * 7 * 36;
			w[0] += 5e8 * R63(r) * f1(pos4.x, pos4.y, pos4.z, r);
			w[1] += 5e8 * R63(r) * f2(pos4.x, pos4.y, pos4.z, r);
			w[2] += 5e8 * R63(r) * f3(pos4.x, pos4.y, pos4.z, r);
			w[3] += 5e8 * R63(r) * f4(pos4.x, pos4.y, pos4.z, r);
			w[4] += 5e8 * R63(r) * f5(pos4.x, pos4.y, pos4.z, r);
			w[5] += 5e8 * R63(r) * f6(pos4.x, pos4.y, pos4.z, r);
			w[6] += 5e8 * R63(r) * f7(pos4.x, pos4.y, pos4.z, r);
		}
